...
def home_html():
    ...
    <div class="app"><div class="container">__NAV__
        ...
        <div class="card voice-card" style="margin-top:24px;"><button id="voiceButton" type="button" class="voice-button">🎙️</button><div id="voiceStatus" class="voice-status">Tap to speak</div><div class="voice-help">Hindi • Marathi • English • Hinglish</div><div id="voiceResult" style="margin-top:25px;"></div></div>
